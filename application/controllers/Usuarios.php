...
class Usuarios extends CI_Controller
{
            ...
            if ($this->form_validation->run()) {
                ...
                if ($this->ion_auth->update($usuario_id, $data)) {
                    ...
                    if ($perfil_usuario_db->id != $perfil_usuario_post) {
                        ...
                        $this->ion_auth->romeve_from_group($perfil_usuario_db->id, $usuario_id);
    ...
    public function username_check($username)
    {
        ...
        $usuario_id = $this->input->post('username');
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $group = array($this->input->post('perfil_usuario')); // Define o usuário como admin.
    ...
    public function del($usuario_id = NULL)
    {
        ...
        if ($this->ion_auth->is_admin($usuario_id)) {
            ...
            $this->session->set_flashdata('sucesso', 'O administrador não pode ser excluido!');
            redirect('usuarios');
        ...
        if ($this->ion_auth->delete_user($usuario_id)) {
            ...
            $this->session->set_flashdata('error', 'Usuário excluido com sucesso!');
            redirect('usuarios');
