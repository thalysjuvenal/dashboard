    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="cadastrar novo usuario" href="<?php echo base_url(('usuarios/add')) ?>"
                    class="btn btn-success btn-sm float-right"><i class="fas fa-user-plus">&nbsp;Novo</i></a>
            </div>
                            ...
                            <?php foreach ($usuarios as $user): ?>
                                <tr>
                                    ...
                                    <td class="text-center pr-4">
                                        <?php echo ($user->active == 1 ? '<span class="badge badge-pill badge-warning btn-sm">Sim</span>' : '<span class="badge badge-pill badge-danger btn-sm">Não</span>') ?>
                                    </td>
                                    <td class="text-right">
                                        ...
                                        <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#user-<?php echo $user->id; ?>"
                                            class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Você realmente deseja deletar esse usuário?</h5>
